public class CoulombCalculator
{
    ...
    private static double GetDistance(Vector2 pos1, Vector2 pos2)
    {
    ...
    public static Vector2 GetForceVector(Charge charge1, Charge charge2)
    {
        ...
        return new Vector2((force * unitX), (force * unitY));
    }
}