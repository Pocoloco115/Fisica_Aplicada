...
2. **Series de Aproximación Exponencial y Análisis de Errores**  
...
dotnet run
```
> Requisitos: Tener instalado el SDK de .NET (versión 9.0 o superior) para usar `dotnet run`.
> Puedes descargarlo desde la página oficial de Microsoft:  
